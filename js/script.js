(function($) {
    ...
    /*================================================================= 
        Map
    ==================================================================*/
    var map = L.map('mapwrapper').setView([20.534691344655, 86.02097316564134], 12);

    L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
        attribution: '&copy; <a href="https://maps.app.goo.gl/8F3WdFf4KACGHyUV7">Alok</a> Alok'
    }).addTo(map);
    ...
    L.marker([20.534691344655, 86.02097316564134], {
        icon: greenIcon
    }).addTo(map);
